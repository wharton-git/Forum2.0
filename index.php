...
<body>
    ...
    <section class="bg-secondary position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
        ...
        <div class="row justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
            ...
            <div class="position-sticky top-0 mb-5 pb-sm-2 pb-xl-4" style="padding-top: 110px;"><img class="d-block mx-auto" src="assets/img/landing/mobile-app-showcase/hero/screen02.png" width="322" alt="App screen"></div>
            </div>
            <div class="col-sm-6 col-lg-4 order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
            <!-- Left app sceen--><img class="d-none d-lg-block rounded-4 ms-auto" src="assets/img/landing/mobile-app-showcase/hero/screen01.png" width="297" alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
            ...
            <!-- Right app screen--><img class="d-none d-lg-block rounded-4" src="assets/img/landing/mobile-app-showcase/hero/screen03.png" width="297" alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
    ...
    <section class="overflow-hidden pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
        ...
        <div class="row align-items-center">
            ...
            <div class="d-flex justify-content-center justify-content-md-start">
                <div class="me-4"><img class="d-dark-mode-none" src="assets/img/landing/mobile-app-showcase/awards/01-dark.png" width="188" alt="Award"><img class="d-none d-dark-mode-block" src="assets/img/landing/mobile-app-showcase/awards/01-light.png" width="188" alt="Award"></div>
    ...
    <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
        ...
        <div class="swiper-wrapper pt-2">
            ...
            <div class="border rounded-4"><img class="d-block d-dark-mode-none mx-auto" src="assets/img/landing/business-consulting/clients/04-dark.svg" width="196" alt="Logo"><img class="d-none d-dark-mode-block mx-auto" src="assets/img/landing/business-consulting/clients/04-light.svg" width="196" alt="Logo"></div>
            </div>
            <div class="swiper-slide">
            <div class="border rounded-4"><img class="d-block d-dark-mode-none mx-auto" src="assets/img/landing/business-consulting/clients/01-dark.svg" width="196" alt="Logo"><img class="d-none d-dark-mode-block mx-auto" src="assets/img/landing/business-consulting/clients/01-light.svg" width="196" alt="Logo"></div>
            </div>
            <div class="swiper-slide">
            <div class="border rounded-4"><img class="d-block d-dark-mode-none mx-auto" src="assets/img/landing/business-consulting/clients/02-dark.svg" width="196" alt="Logo"><img class="d-none d-dark-mode-block mx-auto" src="assets/img/landing/business-consulting/clients/02-light.svg" width="196" alt="Logo"></div>
            </div>
            <div class="swiper-slide">
            <div class="border rounded-4"><img class="d-block d-dark-mode-none mx-auto" src="assets/img/landing/business-consulting/clients/03-dark.svg" width="196" alt="Logo"><img class="d-none d-dark-mode-block mx-auto" src="assets/img/landing/business-consulting/clients/03-light.svg" width="196" alt="Logo"></div>
            </div>
            <div class="swiper-slide">
            <div class="border rounded-4"><img class="d-block d-dark-mode-none mx-auto" src="assets/img/landing/business-consulting/clients/05-dark.svg" width="196" alt="Logo"><img class="d-none d-dark-mode-block mx-auto" src="assets/img/landing/business-consulting/clients/05-light.svg" width="196" alt="Logo"></div>
            </div>
            <div class="swiper-slide">
            <div class="border rounded-4"><img class="d-block d-dark-mode-none mx-auto" src="assets/img/landing/business-consulting/clients/06-dark.svg" width="196" alt="Logo"><img class="d-none d-dark-mode-block mx-auto" src="assets/img/landing/business-consulting/clients/06-light.svg" width="196" alt="Logo"></div>
            </div>
        </div>
        <!-- Pagination (bullets)-->
    ...
    <section class="bg-secondary">
        ...
        <div class="position-relative overflow-hidden rounded-5 px-4 px-sm-5 px-lg-0">
            ...
            <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 pb-sm-3 pt-5 py-md-0 py-lg-5" data-aos="fade-up" data-aos-duration="500" data-aos-offset="250" data-disable-parallax-down="lg">
                ...
                <div class="d-flex flex-column flex-sm-row justify-content-center justify-content-md-start"><a class="btn btn-light btn-lg px-3 py-2 me-sm-3 mb-3 mb-sm-0" href="#"><img class="mx-1" src="assets/img/market/appstore-dark.svg" width="136" alt="App Store"></a><a class="btn btn-light btn-lg px-3 py-2" href="#"><img class="mx-1" src="assets/img/market/googleplay-dark.svg" width="135" alt="Google Play"></a></div>
            </div>
            <div class="col-md-6 col-lg-5 offset-xl-1">
                <!-- Image visible on screens < 768px--><img class="d-block d-md-none mx-auto" src="assets/img/landing/mobile-app-showcase/features/03.png" width="420" alt="App screen">
